...
default_dir = './test_con/output/'
folder = '타임스탬프 폴더'
# Load the GraphML file
graph = nx.read_graphml(default_dir+folder+'/artifacts/clustered_graph.graphml') # summarized_graph  clustered_graph
...
plotly.offline.plot(fig, filename='graph_visualization_summary.html')
# Show the plot
fig.show()
